...
HD_PWD='D:/Users/rahul/Verilog/digital_clock/digital_clock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log s_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source s_display.tcl -notrace
