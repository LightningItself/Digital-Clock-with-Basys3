...
HD_PWD='D:/Users/rahul/Verilog/digital_clock/digital_clock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log s_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source s_display.tcl
